...
function extractIndentation(inputLine, inputObject) {
    ...
    for (var strPos = 0; strPos < inputLine.length; strPos++) {
        ...
        if (inputLine[strPos] === ".") {
            ...
            //Grab a the leading chars.
            if (lineIndentation === 0) {
                lineIndentationLead = inputLine.substring(0, strPos);
            }
    ...
    if (lineIndentationArray.length > 0 || lineIndentationLead.length > 0) {
        if (lineIndentationLead.length > 0) {
            inputObject.lineIndentationLead = lineIndentationLead;
        }
