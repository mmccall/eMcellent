...
function extractIndentation(inputLine, inputObject) {
    ...
    var lineExpression = "";
    var lineIndentationSpaceFlag = false;
    ...
    if (inputLine.substring(0, 1) === ".") {
        ...
        for (var posIS = 0; posIS < inputLine.length; posIS++) {
            ...
            if (inputLine[posIS] === ".") {
                ...
                //console.log('hit');
                //If any dot has trailing space, can set universally for line.
                if (inputLine[posIS + 1] === " " || inputLine[posIS + 1] === "\t") {
                    lineIndentationSpaceFlag = true;
                }
            } else {
    ...
    if (lineIndentation > 0) {
        ...
        inputObject.lineIndentationSpace = lineIndentationSpaceFlag;
