...
function appendComment(inputObject, inputLine) {
    ...
    if (!inputObject.hasOwnProperty("lineLabel") && !inputObject.hasOwnProperty("lineRoutines") && inputObject.hasOwnProperty("lineComment") && inputObject.hasOwnProperty("lineIndentation")) {
